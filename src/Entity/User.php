...
//    }
    ...
    public function getTotalKilometre(): ?float
    {
        return $this->totalKilometre;
    }

    public function setTotalKilometre(?float $totalKilometre): self
    {
        $this->totalKilometre += $totalKilometre;

        return $this;
    }
    public function setSupprTotalKilometre(?float $totalKilometre): self
    {
        $this->totalKilometre -= $totalKilometre;
    ...
    {
        return $this->derniertrajet;
    }

    public function setDerniertrajet(?\DateTimeInterface $derniertrajet): self
    {
